  ...
  return (
    <div className='mt-10 flex items-center justify-between'>
        <div>
            ...
            <h2 className='text-gray-500'>Explore our Cars you might likes</h2>
        </div>
        ...
        <div className='flex gap-5'>
            ...
            <select className="select select-bordered md:block w-full max-w-xs hidden" onChange={(e) => setBrand(e.target.value)}>
